...
def executaCarga():
    ...
    def load_Cargas(connect_ora, mysql_engine,origem ):
        print('Loading Cargas Dimensões....')
        print(datetime.datetime.today())
    

        #print(data_atual)
        #busca todas as tabelas que dos modulos do BI
        sql = "SELECT id, tabela,tipo,modulo,sequencia,string_del,string_ins FROM dw_bifna.queries  WHERE db_origem = '"+origem+"'   AND TIPO  = 'D'  order by tipo asc,sequencia asc;"
